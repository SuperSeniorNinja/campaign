      ...
      <div class="tab-content">                
                            ...
                            <tr>
                              <td class="o_re o_bg-white o_px o_pb-md o_br-t uploadImg" align="center">                                
                                  @if(!isset($survey['banner']) || empty($survey['banner']))
                                    <div class="uploadContent" style="background-image: url('{{ asset('img/survey_header.png')}}')">
                    ...
                    <tr>
                      <td class="o_bg-light o_px-xs" align="center" style="padding-left: 8px;padding-right: 8px;">
                        <table class="o_block" width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation" style="max-width: 800px;margin: 0 auto;box-shadow: 3px 4px #d2cbcb;">
                          <tbody>
                            <tr>
                              <span class="badge badge-danger remove_c_qa" data-id="question6"  style="float: right;padding: 5px;" data-toggle="tooltip" data-placement="top" data-original-title="Remove"><i class="zwicon-delete" style="font-size:20px;"></i></span>
                              <td class="o_bg-white o_px-md o_py o_sans o_text o_text-secondary" align="center" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 16px;line-height: 24px;background-color: #ffffff;color: #424651;padding-left: 24px;padding-right: 24px;padding-top: 16px;padding-bottom: 16px;">
                    ...
                    <tr>
                      <td class="o_bg-light o_px-xs" align="center" style="padding-left: 8px;padding-right: 8px;">
                        <table class="o_block" width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation" style="max-width: 800px;margin: 0 auto;box-shadow: 3px 4px #d2cbcb;">
                          <tbody>
                            <tr>
                              <span class="badge badge-danger remove_c_qa" data-id="question7"  style="float: right;padding: 5px;" data-toggle="tooltip" data-placement="top" data-original-title="Remove"><i class="zwicon-delete" style="font-size:20px;"></i></span>
                              <td class="o_bg-white o_px-md o_py o_sans o_text o_text-secondary" align="center" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 16px;line-height: 24px;background-color: #ffffff;color: #424651;padding-left: 24px;padding-right: 24px;padding-top: 16px;padding-bottom: 16px;">
                                <h5 style="margin-top: 0px;"><textarea class="editable" name="question7">{{$survey['question7']}}</textarea></h5>
                                <div class="custom-control custom-radio" style="text-align: left;margin-bottom: 20px;">
                                    <input type="radio" id="qa6_agree" name="qa7_answer" class="custom-control-input_" style="width: 20px;height: 20px;display: inline-block;" disabled="">
                                    <label class="custom-control-label" for="qa7_agree" style="display: inline-block;">Agree</label>
                                </div>
                                <div class="custom-control custom-radio" style="text-align: left;margin-bottom: 20px;">
                                    <input type="radio" id="qa7_disagree" name="qa7_answer" class="custom-control-input_" style="width: 20px;height: 20px;display: inline-block;" disabled="">
        ...
        <!-- <div class="tab-pane fade" id="response" role="tabpanel">
          @if(isset($feedbacks))
            ...
            @endif
            @if($survey['question6'] !="removed" && !empty($survey['question6']))
            <table width="100%" class="question6" cellspacing="0" cellpadding="0" border="0" role="presentation" style="margin-bottom: 10px;">
              <tbody>
                <tr>
                  <td class="o_bg-light o_px-xs" align="center" style="padding: 0px 8px;">
                    <table class="o_block" width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation" style="border-radius: 4px;max-width: 800px;margin: 0 auto;box-shadow: 3px 4px #d2cbcb;background-color: #fff;">
            ...
            @endif
          @else
            <h5>This user has not got any responses yet.</h5>
          @endif
        </div>  -->               
      </div>
  </div>
