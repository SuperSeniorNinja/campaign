    ...
    <div class="tab-container" style="padding: 20px;max-width: 800px;margin: 0 auto;">
        <form id="survey_form" method="POST" enctype="multipart/form-data" action="{{route('save_survey')}} ">
          ...
          <div class="o_body o_bg-light survey_form" style="width: 100%;margin: 0px;padding: 0px;cursor: pointer;-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;">
                        ...
                        <tbody>
                          <tr>
                            <td class="o_bg-white o_px-md o_py-xl o_xs-py-md o_sans o_text-md o_text-light" align="center" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 19px;line-height: 28px;background-color: #dbe5ea;color: #82899a;padding-left: 24px;padding-right: 24px;padding-bottom: 10px;">
                              ...
                              <h2 class="o_heading o_text-dark o_mb-xxs" style="font-family: Helvetica, Arial, sans-serif;font-weight: bold;margin-top: 0px;margin-bottom: 4px;color: #242b3d;line-height: 39px;"><input class="editable align-center" value="{{$survey['title']}}" style="font-size: 20px;" name="title"></h2>
              ...
              <table width="100%" class="question1" cellspacing="0" cellpadding="0" border="0" role="presentation" style="margin-bottom: 10px;">
                <tbody>
                  <tr>
              ...
              <table width="100%" class="question2" cellspacing="0" cellpadding="0" border="0" role="presentation" style="margin-bottom: 10px;">
                <tbody>
                  <tr>
                    <td class="o_bg-light o_px-xs" align="center" style="padding-left: 8px;padding-right: 8px;">
                      <table class="o_block" width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation" style="max-width: 800px;margin: 0 auto; box-shadow: 3px 4px #d2cbcb;">
              ...
              <table width="100%" class="question3" cellspacing="0" cellpadding="0" border="0" role="presentation" style="margin-bottom: 10px;">
                <tbody>            
                  <tr>
                    <td class="o_bg-light o_px-xs" align="center" style="padding-left: 8px;padding-right: 8px;">
                      <table class="o_block" width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation" style="max-width: 800px;margin: 0 auto;box-shadow: 3px 4px #d2cbcb;">
              ...
              <table width="100%" class="question4" cellspacing="0" cellpadding="0" border="0" role="presentation" style="margin-bottom: 10px;">
                <tbody>
                  <tr>
                    <td class="o_bg-light o_px-xs" align="center" style="padding-left: 8px;padding-right: 8px;">
                      <table class="o_block" width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation" style="max-width: 800px;margin: 0 auto;box-shadow: 3px 4px #d2cbcb;">
                  ...
                  <tr>
                    <td class="o_bg-light o_px-xs" align="center" style="padding-left: 8px;padding-right: 8px;">
                      <table class="o_block" width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation" style="max-width: 800px;margin: 0 auto;box-shadow: 3px 4px #d2cbcb;">
                        <tbody>
                          <tr>
                            <span class="badge badge-danger remove_c_qa" data-id="question5"  style="float: right;padding: 5px;" data-toggle="tooltip" data-placement="top" data-original-title="Remove"><i class="zwicon-delete" style="font-size:20px;"></i></span>
                            <td class="o_bg-white o_px-md o_py o_sans o_text o_text-secondary" align="center" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 16px;line-height: 24px;background-color: #ffffff;color: #424651;padding-left: 24px;padding-right: 24px;padding-top: 16px;padding-bottom: 16px;">
                  ...
                  <tr>
                    <td class="o_bg-light o_px-xs" align="center" style="padding-left: 8px;padding-right: 8px;">
                      <table class="o_block" width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation" style="max-width: 800px;margin: 0 auto;box-shadow: 3px 4px #d2cbcb;">
                        <tbody>
                          <tr>
                            <span class="badge badge-danger remove_c_qa" data-id="question6"  style="float: right;padding: 5px;" data-toggle="tooltip" data-placement="bottom" data-original-title="Remove"><i class="zwicon-delete" style="font-size:20px;"></i></span>
                            <td class="o_bg-white o_px-md o_py o_sans o_text o_text-secondary" align="center" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 16px;line-height: 24px;background-color: #ffffff;color: #424651;padding-left: 24px;padding-right: 24px;padding-top: 16px;padding-bottom: 16px;">
                  ...
                  <tr>
                    <td class="o_bg-light o_px-xs" align="center" style="padding-left: 8px;padding-right: 8px;">
                      <table class="o_block" width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation" style="max-width: 800px;margin: 0 auto;box-shadow: 3px 4px #d2cbcb;">
                        <tbody>
                          <tr>
                            <span class="badge badge-danger remove_c_qa" data-id="question7"  style="float: right;padding: 5px;" data-toggle="tooltip" data-placement="bottom" data-original-title="Remove"><i class="zwicon-delete" style="font-size:20px;"></i></span>
                            <td class="o_bg-white o_px-md o_py o_sans o_text o_text-secondary" align="center" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 16px;line-height: 24px;background-color: #ffffff;color: #424651;padding-left: 24px;padding-right: 24px;padding-top: 16px;padding-bottom: 16px;">
              ...
              @endif
              @if($survey['question8'] !="removed")
              <table width="100%" class="question8" cellspacing="0" cellpadding="0" border="0" role="presentation" style="margin-bottom: 30px;">
                <tbody>
                  <tr>
                    <td class="o_bg-light o_px-xs" align="center" style="padding-left: 8px;padding-right: 8px;">
                      <table class="o_block" width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation" style="max-width: 800px;margin: 0 auto;box-shadow: 3px 4px #d2cbcb;">
                        <tbody>
                          <tr>
                            <span class="badge badge-danger remove_c_qa" data-id="question8"  style="float: right;padding: 5px;" data-toggle="tooltip" data-placement="bottom" data-original-title="Remove"><i class="zwicon-delete" style="font-size:20px;"></i></span>
                            <td class="o_bg-white o_px-md o_py o_sans o_text o_text-secondary" align="center" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 16px;line-height: 24px;background-color: #ffffff;color: #424651;padding-left: 24px;padding-right: 24px;padding-top: 16px;padding-bottom: 16px;">
                              <h5 style="margin-top: 0px;"><textarea class="editable" name="question8" placeholder="Add your custom question here">{{$survey['question8']}}</textarea></h5>
                              <div class="custom-control custom-radio" style="text-align: left;margin-bottom: 20px;">
                                  <input type="radio" id="qa6_agree" name="qa6_answer" class="custom-control-input_" style="width: 20px;height: 20px;display: inline-block;" disabled="">
                                  <label class="custom-control-label" for="qa6_agree" style="display: inline-block;">Agree</label>
                              </div>
              ...
              @endif
              @if($survey['question9'] !="removed")
              <table width="100%" class="question9" cellspacing="0" cellpadding="0" border="0" role="presentation" style="margin-bottom: 30px;">
                <tbody>
                  <tr>
                    <td class="o_bg-light o_px-xs" align="center" style="padding-left: 8px;padding-right: 8px;">
                      <table class="o_block" width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation" style="max-width: 800px;margin: 0 auto;box-shadow: 3px 4px #d2cbcb;">
                        <tbody>
                          <tr>
                            <span class="badge badge-danger remove_c_qa" data-id="question9"  style="float: right;padding: 5px;" data-toggle="tooltip" data-placement="bottom" data-original-title="Remove"><i class="zwicon-delete" style="font-size:20px;"></i></span>
                            <td class="o_bg-white o_px-md o_py o_sans o_text o_text-secondary" align="center" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 16px;line-height: 24px;background-color: #ffffff;color: #424651;padding-left: 24px;padding-right: 24px;padding-top: 16px;padding-bottom: 16px;">
                              <h5 style="margin-top: 0px;"><textarea class="editable" name="question9" placeholder="Add your custom question here">{{$survey['question9']}}</textarea></h5>
                              <div class="custom-control custom-radio" style="text-align: left;margin-bottom: 20px;">
                                  <input type="radio" id="qa6_agree" name="qa6_answer" class="custom-control-input_" style="width: 20px;height: 20px;display: inline-block;" disabled="">
                                  <label class="custom-control-label" for="qa6_agree" style="display: inline-block;">Agree</label>
                              </div>
                ...
                <tbody>
                  <tr>
                    <td width="300" class="o_btn o_bg-success o_br o_heading o_text" align="center" style="font-family: Helvetica, Arial, sans-serif;font-weight: bold;margin-top: 0px;margin-bottom: 0px;font-size: 16px;line-height: 24px;mso-padding-alt: 12px 24px;background-color: #0ec06e;border-radius: 4px;">
                      <button class="o_text-white" type="submit" style="text-decoration: none;outline: none;color: #ffffff;display: block;padding: 12px 24px;mso-text-raise: 3px;border: none;background-color: #0ec06e;">Save</button>
                    </td>
                  </tr>
                </tbody>
              </table>
